...
\begin{document}
    ...
    \begin{flushleft}
        \textcolor{Red3}{\textbf{Execution (EX) details}}
    \end{flushleft}
    \begin{itemize}
    ...
    \begin{figure}[!htp]
        ...
        \caption{A basic implementation of MIPS data path.}
    ...
    \begin{figure}[!htp]
        ...
        \caption{An implementation of MIPS data path (no Control Unit).}
    ...
    \begin{figure}[!htp]
        ...
        \caption{A complete implementation of MIPS data path.}
