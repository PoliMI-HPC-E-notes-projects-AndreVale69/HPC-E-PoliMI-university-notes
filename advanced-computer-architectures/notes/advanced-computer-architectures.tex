...
% \includeonly{
%   sections/vliw/introduction,
%   sections/vliw/data-dependences,
%   sections/vliw/statically-scheduled-processors,
%   sections/vliw/code-scheduling/code-scheduling,
%   sections/vliw/code-scheduling/scheduling-basics,
%   sections/vliw/code-scheduling/dependence-graph-and-critical-path,
%   sections/vliw/code-scheduling/asap-scheduling-algorithm,
%   sections/vliw/code-scheduling/list-based-scheduling-algorithm,
%   sections/vliw/code-scheduling/local-vs-global-scheduling,
%   sections/vliw/code-scheduling/local-scheduling-techniques/loop-unrolling,
%   sections/vliw/code-scheduling/local-scheduling-techniques/software-pipelining,
%   sections/vliw/code-scheduling/global-scheduling-techniques/trace-scheduling,
%   sections/vliw/code-scheduling/global-scheduling-techniques/superblock-scheduling
% }
