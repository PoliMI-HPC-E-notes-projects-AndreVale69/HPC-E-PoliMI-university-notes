...
\begin{document}
    ...
    \include{sections/instruction-level-parallelism/register-renaming/introduction}
    \include{sections/instruction-level-parallelism/register-renaming/tomasulo-algorithm}
