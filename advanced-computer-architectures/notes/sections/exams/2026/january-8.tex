...
\begin{itemize}
    ...
    \answer (see \autopageref{sec:correlating-branch-prediction}) The \definition{Correlating Predictor} (also known as \textbf{correlating branch prediction technique}) improves accuracy by \textbf{using the outcomes of recently executed branches to predict the current branch}.
