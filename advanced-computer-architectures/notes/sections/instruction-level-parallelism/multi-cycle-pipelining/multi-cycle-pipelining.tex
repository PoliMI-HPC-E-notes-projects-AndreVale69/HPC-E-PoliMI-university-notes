...
\begin{enumerate}\label{def: in-order issue}
    ...
    \item \textbf{Instructions} are typically \definitionWithSpecificIndex{issued in-order}{In-Order Issue}{} (fetched and passed into the pipeline in the order that they appear in the program).
