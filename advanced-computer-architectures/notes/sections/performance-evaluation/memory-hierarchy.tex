\subsection{Memory Hierarchy}\label{subsection: Memory Hierarchy}
...
\begin{itemize}
    ...
    \item \hqlabel{def: Hit Time}{\definition{Hit Time}}. Time to \textbf{access} the upper memory level and check whether it's a hit.
...
\begin{flushleft}
    ...
    \phantomsection\label{def:l1-cache}
\end{flushleft}
There are two major architectures for \definition{L1 Cache}:
\begin{itemize}
