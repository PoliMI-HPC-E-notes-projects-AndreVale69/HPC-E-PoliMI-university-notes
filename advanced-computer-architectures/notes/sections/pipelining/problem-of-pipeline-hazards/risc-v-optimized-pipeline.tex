...
\begin{enumerate}[label=\textcolor{Green3}{\faIcon{check}}]
   ...
   \item \textcolor{Green3}{\textbf{Forwarding (Bypassing) to Reduce Stalls}}. \definition{Forwarding} (also called \textbf{bypassing}) is a hardware technique that \textbf{eliminates stalls by providing ALU results directly to dependent instructions without waiting for the WB stage}. It is a possible solution for Data Hazards.
