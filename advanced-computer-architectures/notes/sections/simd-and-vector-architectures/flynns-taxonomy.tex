...
\begin{itemize}
    ...
    \item \label{def: MIMD} \definition{MIMD (Multiple Instruction, Multiple Data)}. \hl{Multiple independent processors, each with its own PC, instruction stream, and data.} This is the model of \textbf{multicore CPUs, clusters, distributed-memory systems}. Threads can be tightly or loosely coupled.
\end{itemize}
