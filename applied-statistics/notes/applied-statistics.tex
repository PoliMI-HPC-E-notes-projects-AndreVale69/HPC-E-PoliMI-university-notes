...
\begin{document}
    ...
    \begin{justify}
        \large
        \textbf{Geometrical interpretation of the process of finding a sample mean}
    \end{justify}
    ...
    \end{equation}
    Where the \textbf{cosine} of the angle is the \definition{sample correlation coefficient}. Thus:
    \begin{itemize}
