...
\begin{enumerate}
    ...
    \item\label{def: Partitional Clustering} \important{Partitional Clustering} (also called flat clustering): divides data into $k$ non-overlapping groups. Each data point belongs to exactly one cluster.
\end{enumerate}
