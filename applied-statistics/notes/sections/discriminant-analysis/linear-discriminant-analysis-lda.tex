...
\begin{enumerate}
    ...
    \end{itemize}
    To make this easier to work with, we \textbf{take the logarithm} of this expression (log doesn't change which class is biggest). This gives the \definition{Discriminant Function}:
    \begin{equation}
