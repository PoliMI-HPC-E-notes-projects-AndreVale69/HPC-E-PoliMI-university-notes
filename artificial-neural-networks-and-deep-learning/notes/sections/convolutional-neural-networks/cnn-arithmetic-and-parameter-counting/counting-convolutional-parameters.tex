...
\begin{equation}\label{eq:number-of-trainable-parameters-for-n-filters}
...
\begin{figure}[!htp]
  \centering
  \tikzsetnextfilename{counting-convolutional-parameters-derivation}
  \tikzwidth{\linewidth}
  \begin{tikzpicture}[
    >=stealth,
    scale=1.0,
...
\begin{equation}\label{eq:trainable-parameters-for-one-filter}
