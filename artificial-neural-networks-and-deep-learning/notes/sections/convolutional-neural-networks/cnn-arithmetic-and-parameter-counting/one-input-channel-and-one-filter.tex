...
\noindent
Considering the previous figure. If the input is $5 \times 5$, and the kernel is $3 \times 3$, with a stride (i.e., step size) of 1 and no padding, the filter can occupy only $3 \times 3$ different positions. Therefore, the output will be $3 \times 3 \times 1$.
