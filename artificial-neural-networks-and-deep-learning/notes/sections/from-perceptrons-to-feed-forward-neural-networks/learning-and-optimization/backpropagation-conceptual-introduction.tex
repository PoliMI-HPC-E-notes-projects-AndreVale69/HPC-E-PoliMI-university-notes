...
\end{flushleft}
\textcolor{Red2}{\faIcon{exclamation-triangle}} The \textbf{problem} we face is \textbf{computational}:
\begin{itemize}
...
\highspace
\begin{flushleft}
    \textcolor{Green3}{\faIcon{check-circle} \textbf{Backpropagation Concept}}
\end{flushleft}
...
\begin{examplebox}[: Numerical Example of Backpropagation Concept]
    ...
    \begin{center}
        \tikzsetnextfilename{backpropagation-conceptual-introduction}
