\subsubsection{Hebbian Learning Rule}\label{sec:hebbian-learning-rule}
...
\begin{equation}\label{eq:hebbian-weight-change}
...
\begin{equation}\label{eq:hebbian-weight-update}
