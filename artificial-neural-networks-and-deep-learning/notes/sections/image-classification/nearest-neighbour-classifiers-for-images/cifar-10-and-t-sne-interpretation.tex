...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{img/cnn/cifar10_raw_pixels_tsne.pdf}
    \captionsetup{singlelinecheck=off}
    \caption[]{t-SNE visualization of CIFAR-10 images in the original pixel space.}
    \label{fig:cifar10_raw_pixels_tsne}
\end{figure}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=\textwidth]{img/cnn/cifar10_cnn_embeddings_tsne.pdf}
    \captionsetup{singlelinecheck=off}
    \caption[]{t-SNE visualization of CIFAR-10 images in the CNN embedding space.}
    \label{fig:cifar10_cnn_embeddings_tsne}
\end{figure}
