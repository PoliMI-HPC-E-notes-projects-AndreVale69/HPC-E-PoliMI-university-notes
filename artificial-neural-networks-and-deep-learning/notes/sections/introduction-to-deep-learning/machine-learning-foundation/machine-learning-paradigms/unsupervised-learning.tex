\paragraph{Unsupervised Learning}\label{sec:unsupervised-learning}
...
\highspace
\begin{flushleft}
    \textcolor{Green3}{\faIcon{book} \textbf{The most intuitive unsupervised task: Clustering}}\phantomsection\label{def:clustering}
\end{flushleft}
