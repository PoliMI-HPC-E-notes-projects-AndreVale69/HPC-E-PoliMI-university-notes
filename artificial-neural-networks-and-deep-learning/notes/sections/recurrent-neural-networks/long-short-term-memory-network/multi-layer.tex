...
\begin{itemize}
    \item[\textcolor{Red2}{\faIcon{times}}] In a \emph{single-layer LSTM}, the cell sees only the raw sequence input at each timestep. It must learn both low-level and high-level temporal patterns from this input. This makes \textbf{learning complex patterns more difficult}.
...
\begin{figure}[!htp]
    \centering
    \tikzsetnextfilename{multi-layer-lstm-unrolled-over-time}
