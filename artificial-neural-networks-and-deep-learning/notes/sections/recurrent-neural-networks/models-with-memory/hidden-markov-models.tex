...
// Initialization
// For each state $\textcolor{codegreen}{j}$, compute the initial Viterbi score
// (i.e., the probability of starting in state $\textcolor{codegreen}{j}$ and emitting $\textcolor{codegreen}{y_1}$)
...
// Recursion
// For each time step from 2 to $\textcolor{codegreen}{T}$,
// compute the Viterbi scores and pointers for each state $\textcolor{codegreen}{j}$
// by considering all possible previous states $\textcolor{codegreen}{i}$
