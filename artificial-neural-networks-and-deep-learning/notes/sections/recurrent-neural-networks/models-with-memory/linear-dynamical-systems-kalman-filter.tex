...
\highspace
\begin{flushleft}
    \textcolor{Red2}{\faIcon{exclamation-triangle} \textbf{State Estimation Problem}}\label{def:state-estimation-problem}
\end{flushleft}
