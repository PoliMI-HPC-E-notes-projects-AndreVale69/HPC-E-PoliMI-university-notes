...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Recurrent Neural Networks (RNNs)} (\autopageref{sec:rnn-definition}): Use non-linear functions to update the hidden state, allowing for complex temporal dependencies.
    \end{itemize}
\end{itemize}