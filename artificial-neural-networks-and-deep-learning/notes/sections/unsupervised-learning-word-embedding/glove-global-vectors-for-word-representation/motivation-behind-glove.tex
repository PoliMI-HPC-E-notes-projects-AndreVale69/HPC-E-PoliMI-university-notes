...
\highspace
\textcolor{Green3}{\faIcon{question-circle} \textbf{The Central Question.}} The authors of \definition{GloVe (Global Vectors for Word Representation)} wondered whether \hl{these semantic regularities could be learned more directly.} Instead of learning embeddings by solving a prediction problem, they proposed \hl{learning them from the statistical structure of the entire corpus.} In other words:
\begin{itemize}
