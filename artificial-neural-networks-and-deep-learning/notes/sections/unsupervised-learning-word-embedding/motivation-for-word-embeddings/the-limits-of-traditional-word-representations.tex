...
\highspace
\begin{flushleft}
    \textcolor{Red2}{\faIcon{exclamation-triangle} \textbf{Dictionary IDs}}
\end{flushleft}
...
\highspace
\begin{flushleft}
    \textcolor{Red2}{\faIcon{exclamation-triangle} \textbf{One-Hot Encoding}}
\end{flushleft}
To remove the artificial ordering introduced by dictionary IDs, NLP systems often use \textbf{one-hot encoding}.
...
\highspace
\begin{flushleft}
    \textcolor{Red2}{\faIcon{exclamation-triangle} \textbf{Bag-of-Words (BoW)}}
\end{flushleft}
When working with complete documents, \emph{one-hot vectors} are often \textbf{aggregated} into a \textbf{Bag-of-Words representation}.
...
\highspace
\begin{flushleft}
    \textcolor{Red2}{\faIcon{exclamation-triangle} \textbf{The Curse of Dimensionality}}
\end{flushleft}
