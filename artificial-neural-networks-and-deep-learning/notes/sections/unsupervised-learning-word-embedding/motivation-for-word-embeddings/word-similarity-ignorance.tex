...
The previous section showed that traditional representations such as one-hot encoding are sparse and high-dimensional. However, an even more serious problem exists: \textbf{one-hot vectors completely ignore semantic similarity between words}. For example, consider the following twosentences:
\begin{itemize}
