...
\begin{itemize}
    ...
    \hqlabel{problema-cauchy-con-eulero-indietro}{\textcolor{Green3}{\faIcon{check-circle} \textbf{\emph{Soluzione.}}}} Dato il solito problema di Cauchy:
    \begin{equation*}
        y'(t) = f(t, y(t)) \quad y(t_0) = y_0
    \end{equation*}
    L'obbiettivo è lo stesso di Eulero in avanti (pagina \hqpageref{problema-cauchy-con-eulero-avanti}), ovvero calcolare dei valori approssimati $u_{n} \approx y\left(t_{n}\right)$ in certi istanti $t_{n} = t_{0} + n h$.
