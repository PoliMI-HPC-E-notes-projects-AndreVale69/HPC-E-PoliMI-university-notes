...
\newcommand{\trueIcon}{\textcolor{Green3}{\faIcon{check}}}
\newcommand{\falseIcon}{\textcolor{Red2}{\faIcon{times}}}
\newcommand{\version}{v2.0.0}

% deployment
% \includeonly{
%     sections/exams/2025/february-3,
%     sections/exams/2025/january-13,
%     sections/exams/2024/september-5,
%     sections/exams/2024/june-12,
%     sections/exams/2023/july-7
% }
...
\begin{document}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \include{sections/hardware-infrastructures/system-level}
    \include{sections/hardware-infrastructures/node-level}
    \include{sections/hardware-infrastructures/building-level}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Software Infrastructures %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \include{sections/software-infrastructure/virtualization}
    \include{sections/software-infrastructure/computing-architectures}

    %%%%%%%%%%%
    % Methods %
    %%%%%%%%%%%
    \include{sections/methods/reliability-and-availability-of-data-centers}
    \include{sections/methods/disk-performance}
    \include{sections/methods/scalability-and-performance-of-data-centers}

    %%%%%%%%%
    % Exams %
    %%%%%%%%%
    \include{sections/exams/2025/february-3}
    \include{sections/exams/2025/january-13}
    \include{sections/exams/2024/september-5}
    \include{sections/exams/2024/june-12}
    \include{sections/exams/2023/july-7}
