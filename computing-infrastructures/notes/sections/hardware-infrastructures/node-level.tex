...
In fact, the \emph{probability of a failure} (assuming independent failures) in an array of 100 disks is 100 higher than the probability of a failure of a single disk! For \textcolor{Green4}{\textbf{example}}, if a disk has a mean time to failure (MTTF) of 200.000 hours (23 years), an array of 100 disks will show an MTTF of 2000 hours (3 months).
