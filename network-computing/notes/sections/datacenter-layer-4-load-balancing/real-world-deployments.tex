...
\end{flushleft}
Azure's technique stands out \textbf{because it takes a very different design philosophy} compared to Alibaba, Meta, or Google. While Alibaba and Meta focus on \textbf{scaling L4 load balancing in hardware}, \textbf{Microsoft prioritizes control, observability, and integration} with the cloud platform, even at the cost of higher per-connection overhead.\phantomsection\label{def:tcp-termination}
...
\begin{flushleft}
    ...
    \phantomsection\label{def:maglev}
\end{flushleft}
