...
\begin{itemize}
    \item[\faIcon{github}] \href{https://github.com/PoliMI-HPC-E-notes-projects-AndreVale69/network-computing-project}{TCP Connection Tracker (eBPF/XDP)}
    \begin{center}
        \qrcode{https://github.com/PoliMI-HPC-E-notes-projects-AndreVale69/network-computing-project}
    \end{center}
\end{itemize}