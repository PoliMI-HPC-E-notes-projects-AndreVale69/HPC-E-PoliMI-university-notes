\subsection{Data Plane Programming and P4}\label{subsection: Data Plane Programming and P4}
...
\begin{enumerate}
    ...
    \item \important{Protocol Independence}: The switch should not be tied to Ethernet/IP/\break TCP. \hl{We define the packet format}.
