...
\highspace
Let us consider the following \definition{Poisson problem} with (homogeneous) Dirichlet boundary conditions: find $u : \Omega \subset \mathbb{R} \rightarrow \mathbb{R}$ such that:
