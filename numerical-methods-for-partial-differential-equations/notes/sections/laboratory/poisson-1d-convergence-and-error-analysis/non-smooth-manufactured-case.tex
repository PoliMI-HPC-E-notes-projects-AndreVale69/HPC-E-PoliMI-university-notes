\subsubsection{Non-smooth manufactured case}\label{sec:non-smooth-manufactured-case}
...
\begin{flushleft}
    \hqlabel{sec:non-smooth-manufactured-case}{\textcolor{Green3}{\faIcon{question-circle} \textbf{What changes in convergence behavior?}}}
\end{flushleft}
