...
\begin{document}
    ...
    % p. 3-26 Dependencies
    % p.27-28 Intro to parallel patterns
    % p.29-30 Nesting Pattern
    % p.31-35 Serial Control Pattern
    % p.36-44 Parallel Control Pattern
    % p.45-49 Serial Data Management Pattern
    % p.50-55 Parallel Data Management Pattern
    % p.56-57 Other Parallel Patterns
    % p.58-89 Map Pattern
    %   - p.59-71 Map
    %   - p.72-74 Optimizations
    %       - p.72 Sequences of Maps
    %       - p.73 Code Fusion
    %       - p.74 Cache Fusion
    %   - p.75-78 Related Patterns
    % -------------------------------------------------------------------
    %   - p.79-89 Example Implementation: Scaled Vector Addition (SAXPY)
    %       - p.79-83 Problem Description
    %       - p.84-89 Various Implementations
