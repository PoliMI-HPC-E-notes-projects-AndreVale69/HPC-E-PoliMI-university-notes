...
\begin{document}
    ...
    % - CUDA and OpenMP or MPI
    %   - CUDA API for multi-GPUs (p.6, p.8)
    %   - Memory management with multiple GPUs (p.9, p.15)
    %   x p.16, p.17 duplicate
    %   - Batch processing and cooperative patterns with OpenMP (p. 18, p.20)
    %   - OpenMP for heterogeneous architectures (p.21, p.27)
    %   - MPI-CUDA applications (p.28, p.34)
