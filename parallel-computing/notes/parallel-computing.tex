...
\begin{document}
    ...
    % 3.3 C
    %   Scatter Pattern
    %       - What is a Scatter? 34-43
    %       - Collision Rules (what are?)
    %           - Atomic Scatter 45-48
    %           - Permutation Scatter 49
    %           - Merge Scatter 50-52
    %           - Priority Scatter 53
    %           - Converting Scatter to Gather 54
    %   Pack Pattern
    %       - What is a Pack? 56-60
    %       - Split 62-63
    %       - Unsplit 64
    %       - Bin 65
    %       - Fusion of Map and Pack 67
    %       - Expand 69-70
    %   Partitioning Data 72-75
    % ---------------------------------------------
    %   AoS vs. SoA 77-79
    %   Example Aos vs. SoA 81-83
    % 3.4 Stencil (from page 56)
