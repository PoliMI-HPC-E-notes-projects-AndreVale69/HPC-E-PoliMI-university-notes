...
\begin{document}
    ...
    % 5. DSL - HLS
    %   - Heterogeneous processing p. 2
    %   - Energy-efficient computing p. 3-5
    %   - Heterogeneous processing p. 6
    %   - Energy-efficient computing p. 7
    %   - Heterogeneous parallel programming p. 8-10
    %   - Domain-Specific Languages (DSL) p. 11
    %   - Why image processing p. 12
    %   - Making image processing faster p. 13
    %   - Existing solutions p. 14
    %   - Halide p. 15
    %   - Code example p. 16-24
    %   - More on scheduling and performance p. 25-37
    %   - Heterogeneous parallel programming p. 38-39
