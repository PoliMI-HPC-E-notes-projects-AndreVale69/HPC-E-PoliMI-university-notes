...
%     sections/exams/2025-january-22th,
%     sections/exams/2024-december-19th
% }
...
\begin{document}
    ...
    \include{sections/heterogeneous-computing-dsls-and-hls/hls-compilation-and-optimization}
    \include{sections/heterogeneous-computing-dsls-and-hls/scheduling-in-hls}

    %%%%%%%%%
    % Exams %
    %%%%%%%%%
    \include{sections/exams/exams}
    \include{sections/exams/2025-january-22th}
    \include{sections/exams/2024-december-19th}
