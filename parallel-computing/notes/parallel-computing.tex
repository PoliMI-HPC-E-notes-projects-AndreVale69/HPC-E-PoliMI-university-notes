...
% development:
% \includeonly{
%     sections/parallel-patterns-in-openmp-and-cuda/openmp,
%     sections/parallel-patterns-in-openmp-and-cuda/histogram-pattern,
%     sections/parallel-patterns-in-openmp-and-cuda/reduction-pattern
% }
...
\begin{document}
    ...
    %   - Parallel patterns in OpenMP and CUDA (1-56)
    %       - Common Parallel Patterns on OpenMP p. 3-8
    %           - Map Pattern p. 3
    %           - Reduction Pattern p. 4
    %           - Workpile Pattern p. 5 
    %           - Scan Pattern p. 6-8
    %       - Histogram pattern p. 9-15
    %           - Data partitioning p. 16-19
    %       - Histogram pattern (continue) p. 20
    %       - Data races p. 21-22
    %           - Atomic operations p. 23-28
    %           - Privatization p. 29-34
    % --------------------------------------------------
    %       - Reduction pattern p. 35-43
    %       - Scan Pattern - CUDA p. 44-55
    % 5. DSL - HLS
