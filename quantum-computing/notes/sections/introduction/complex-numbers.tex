...
\begin{figure}[!htp]
    \centering
    \tikzsetnextfilename{complex-number-cartesian-polar}
...
\begin{figure}[!htp]
    \centering
    \tikzsetnextfilename{complex-number-conjugate}
    \begin{tikzpicture}[scale=1.2, >=Stealth]
...
\begin{flushleft}
    \textcolor{Green3}{\faIcon{book} \textbf{Magnitude}}\phantomsection\label{sec:magnitude}
\end{flushleft}
...
\begin{figure}[!htp]
    \centering
    \tikzsetnextfilename{complex-number-rotation}
    \begin{tikzpicture}[scale=1.2, >=Stealth]
