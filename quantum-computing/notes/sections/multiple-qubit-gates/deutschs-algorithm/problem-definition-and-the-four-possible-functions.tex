\subsection{Deutsch's Algorithm}\label{ex:deutschs-algorithm}

\subsubsection{Problem Definition and the Four Possible Functions}\label{ex:problem-definition-and-the-four-possible-functions}
