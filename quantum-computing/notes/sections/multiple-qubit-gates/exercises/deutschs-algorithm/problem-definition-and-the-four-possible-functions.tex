\subsubsection{Deutsch's Algorithm}\label{ex:deutschs-algorithm}

\paragraph{Problem Definition and the Four Possible Functions}\label{ex:problem-definition-and-the-four-possible-functions}
