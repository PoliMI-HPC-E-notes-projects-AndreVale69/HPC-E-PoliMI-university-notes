...
\phantomsection\label{subsubsec:exponential-explosion}\highspace
...
\end{itemize}
This is why quantum computing is so powerful: it can \textbf{process many possibilities at the same time} and \textbf{manipulate them so that only the correct ones survive}. This will become clear when we introduce entanglement (\autopageref{subsubsec:why-entanglement-matters}).
