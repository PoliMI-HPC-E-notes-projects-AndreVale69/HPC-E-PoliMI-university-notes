...
\begin{definitionbox}[: Observable]
    An \definition{Observable} is a \textbf{Hermitian operator} $O$ associated with a measurable quantity of a quantum system:
    \begin{equation*}
        O = O^{\dagger}
    \end{equation*}
...
\begin{enumerate}
    ...
    This property is \hl{crucial because quantum measurement requires a basis whose states are both perfectly distinguishable and probabilistically consistent.}
    \begin{itemize}
        \item[\textcolor{Red2}{\faIcon{times}}] If eigenvectors were not orthogonal, different measurement states could partially overlap:
        \begin{equation*}
            \braket{v_1}{v_2} \neq 0
        \end{equation*}
        ...
        \item[\textcolor{Red2}{\faIcon{times}}] If eigenvectors were not normalized:
        \begin{equation*}
            \braket{v}{v} \neq 1
        \end{equation*}
