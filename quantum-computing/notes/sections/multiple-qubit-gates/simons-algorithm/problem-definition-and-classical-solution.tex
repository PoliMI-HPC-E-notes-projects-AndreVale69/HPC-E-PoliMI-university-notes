...
\noindent
This is \definition{Simon's Promise}. The \textbf{goal} of Simon's algorithm is therefore simply to \textbf{find the hidden bitstring} $a$. But let's understand \textbf{\emph{what the promise actually means}} before thinking about how to solve the problem.
...
\begin{flushleft}
    \textcolor{Red2}{\faIcon{dice} \textbf{Randomized classical solution}}\phantomsection\label{sec:randomized-classical-solution-simons}
\end{flushleft}
