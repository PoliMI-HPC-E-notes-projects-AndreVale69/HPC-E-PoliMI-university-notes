...
Where:
\begin{itemize}
    \item $\text{penalty}(\mathbf{x})$ is a \textbf{function} that \textbf{measures the violation of the constraints}.
    ...
    \item $\gamma$ is a \textbf{coefficient} controlling \textbf{how strongly violations are punished}.
\end{itemize}
