...
\noindent
The two lowest points of the landscape represent the ground states of the problem.
Since these configurations correspond exactly to the assignments satisfying
$a \neq b$, minimizing the QUBO energy function automatically solves the original
boolean problem.