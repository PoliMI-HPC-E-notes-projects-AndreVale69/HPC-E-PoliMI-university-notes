\subsubsection{QUBO as an Energy Minimization Problem}\label{sec:qubo-as-an-energy-minimization-problem}\label{def:ground-state}
...
\begin{examplebox}[: QUBO Energy Landscape]
    ...
    \begin{center}
        \tikzsetnextfilename{qubo-energy-landscape-surface}
        \begin{tikzpicture}
            \begin{axis}[
                view={45}{30},
                xlabel={$x_1$},
