...
\end{flushleft}
The \definitionWithSpecificIndex{Initialization}{Single Qubit Gates: Initialization}{} of qubits is the process of \textbf{setting them into a known, well-defined state}, most commonly $\quantumState{0}$ or $\quantumState{1}$. \hl{Initialization is essential because quantum algorithms require precisely defined input states}.
