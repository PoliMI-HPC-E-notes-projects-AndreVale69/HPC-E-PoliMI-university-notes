...
\begin{equation}\label{eq:inner-product-2}
    \braket{a}{b} = \begin{pmatrix}
        \overline{a_{1}} & \overline{a_{2}}
    \end{pmatrix}
    \begin{pmatrix}
        b_{1} \\
        b_{2}
...
So:
\begin{itemize}
    \item \textbf{Inner product} $\rightarrow$ \textbf{projection}, result is number (scalar, see also \autopageref{eq:inner-product}).
