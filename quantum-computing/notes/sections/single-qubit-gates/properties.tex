...
\begin{itemize}
    \item \texttt{X Gate} $\rightarrow$ Rotation $\pi$ around x-axis (section~\ref{sec:pauli-x-not-gate}, page~\pageref{sec:pauli-x-not-gate})
    \item \texttt{Z Gate} $\rightarrow$ Rotation $\pi$ around z-axis (section~\ref{sec:pauli-z-phase-flip-gate}, page~\pageref{sec:pauli-z-phase-flip-gate})
    ...
    \item \texttt{H Gate} $\rightarrow$ Rotation $\frac{\pi}{2}$ around y, then $\pi$ around x (section~\ref{subsubsec:hadamard-gate-h}, page~\pageref{subsubsec:hadamard-gate-h})
\end{itemize}
