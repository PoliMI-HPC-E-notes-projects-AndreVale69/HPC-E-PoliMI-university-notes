...
\end{flushleft}
One might think of copying the qubit before measurement to extract more information. However, quantum mechanics forbids this through the \definition{No-Cloning Theorem} (we will see more about this on \autopageref{sec:no-cloning-principle}).
