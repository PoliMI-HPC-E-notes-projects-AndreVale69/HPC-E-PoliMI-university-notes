...
\begin{itemize}
    ...
    \begin{center}
        \tikzsetnextfilename{coherent-state-wave-analogy}
        \begin{tikzpicture}
            \draw[->] (0,0) -- (8,0);
    ...
    \begin{center}
        \tikzsetnextfilename{loss-of-coherence-dephasing}
        \begin{tikzpicture}
            \draw[->] (0,0) -- (8,0);
    ...
    \begin{center}
        \tikzsetnextfilename{complete-loss-of-coherence}
        \begin{tikzpicture}
            \draw (0,0) -- (8,0);
    ...
    \begin{center}
        \tikzsetnextfilename{classical-mixture-probabilities}
        \begin{tikzpicture}
    ...
    \begin{center}
        \tikzsetnextfilename{constructive-interference-wave-analogy}
        \begin{tikzpicture}
            \draw[->] (0,0) -- (8,0);
    ...
    \begin{center}
        \tikzsetnextfilename{destructive-interference-wave-analogy}
        \begin{tikzpicture}
            \draw[->] (0,0) -- (8,0);
