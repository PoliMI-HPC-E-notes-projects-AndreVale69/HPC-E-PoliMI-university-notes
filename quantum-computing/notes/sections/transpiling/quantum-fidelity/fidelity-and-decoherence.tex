...
\begin{equation}\label{eq:fidelity-decoherence}
...
\end{equation*}
This means the gate has a fidelity of approximately 99.5\%. Therefore, optimizing gate times is crucial for enhancing the fidelity of quantum operations, as it directly reduces the error probability associated with decoherence.\phantomsection\label{def:threshold-theorem}
