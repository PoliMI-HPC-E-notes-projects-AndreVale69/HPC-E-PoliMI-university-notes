...
\begin{itemize}
    ...
    \item \textbf{Parallelism}: it is a property of hardware. \textbf{The execution of different tasks/pieces of software at the same time}.
...
\end{itemize}
\textbf{PDC} provides the theoretical and programming foundations (concurrency, parallelism, distribution), while \textbf{HPC} applies these principles in practice through high-performance systems such as clusters, supercomputers, and cloud infrastructures.
